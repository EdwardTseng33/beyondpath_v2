...
(function (g) {
  ...
  "client": {
    ...
    "suggested_expert": "[EN] Tier A+ 領域專家",
    "suggested_visual": "[EN] 視覺 · 50%",
    "suggested_copy": "[EN] 文案 · 30%",
    "suggested_schedule": "[EN] 排程 · 20%",
    "filter_mercy_boost": "[EN] 反馬太加成 · 1",
    "lbl_tier_zh": "[EN] 期待認證等級",
    "rail_why_p1": "[EN] 客戶輸入需求 → 平台 AI 拆解 → 配給合適 AI 工作者執行 → 雙邊評鑑 → 數據回到推薦系統。",
    "rail_why_flywheel": "[EN] B1 → B4 → B5 → B2 → B3 飛輪",
    "rail_why_punc": "[EN] 。",
    "rail_tip0_a": "[EN] 想清楚是",
    "rail_tip0_auto": "[EN] 內容自動化",
    "rail_tip0_b": "[EN] 還是",
    "rail_tip0_strategy": "[EN] 策略諮詢",
    "rail_tip0_c": "[EN] 。前者走 worker pool，後者通常需要 Tier A+ 雙領域。",
    "rail_tip1_narrow": "[EN] 條件越嚴 → 配對池越窄。推薦先寬，看完前 5 名再回來收緊。",
    "rail_tier_guide": "[EN] Tier 指南",
    "rail_colon": "[EN] ：",
    "rail_tier_b": "[EN] B 實踐者",
    "rail_tier_b_desc": "[EN] 通過驗證 · 完成 3 件 NPS≥4，市價 −10%",
    "rail_tier_a": "[EN] A 專家",
    "rail_tier_a_desc": "[EN] 通過 < 10% 篩選，市價",
    "rail_tier_aplus": "[EN] A+ 大師",
    "rail_tier_aplus_desc": "[EN] 垂直領域認證（DTC / 品牌 DNA × AI），+15%",
    "rail_tier_s": "[EN] S 典範",
    "rail_tier_s_desc": "[EN] 雙領域大師 · 2 年以上紀錄，+35%",
    "rail_tier_any_desc": "[EN] AI 自動匹配",
    "rail_tier_warn": "[EN] ※ 未驗證接案者不會進入配對池",
    "rail_tier_warn_after": "[EN] ，等級越高接案費率越高，預算需求隨之上升。",
    "rail_tip2": "[EN] AI 拆解結果 = 合約附件 A，會直接綁進 Step 6 合約草稿預覽範圍。",
    "rail_tip3": "[EN] 載入 / 檔期 / Tier / NPS / 領域 / 聲量 = 100 分。+10 反馬太、+5 loyalty、−5 連拒。",
    "portfolio_first_case": "[EN] 首案進行中 · 完成後解鎖 portfolio · 可從 voice / 領域 match 評估",
    "portfolio_modal_stub": "[EN] (完整 case study modal · 下個 sprint)"
  },
  "worker": {
    ...
    "badge_dtc_sub": "[EN] unlocked 2024-09",
    "badge_bd_sub": "[EN] unlocked 2024-12",
    "badge_s_sub": "[EN] 8% to go",
    "badge_rt_sub": "[EN] 需 3 個 retainer 案",
    "subsidy_claude": "[EN] 已啟用 · 平台支付 NT$700/mo",
    "subsidy_chatgpt": "[EN] 已啟用 · 平台支付 NT$900/mo",
    "subsidy_mj": "[EN] 已啟用 · NT$960/mo",
    "subsidy_figma": "[EN] 已啟用 · NT$940/mo",
    "summary_intro_pre": "[EN] 你的 ",
    "summary_intro_post": "[EN]  已穩居 Tier A+ DTC 領先群。下一個 unlock（Tier S）的瓶頸是",
    "course_reels_paid": "[EN] 平台補貼 100%",
    "course_copy_paid": "[EN] 平台補貼 NT$4,800 / 6,000",
    "practice_reels_who": "[EN] AI 模擬客戶 brief × 6",
    "practice_reels_paid": "[EN] 免費 · Tier A+ 福利",
    "tool_runway_why": "[EN] 你的 Reels 短影音可從 KV 直接生成 · 估計時程 -40%",
    "tool_claude_why": "[EN] 你 LUMINE 已用過、可一鍵複製到 HANA / Plant",
    "tool_arcads_why": "[EN] 績效型短影片 · 補你 Performance copy 弱項",
    "tool_figma_why": "[EN] 從 KV 直接出可互動 mock，retainer 案常用",
    "inbox_aura_zh": "[EN] 8 週・3 SKU 全套素材・retainer 入口・client NPS 4.7",
    "inbox_wahmi_zh": "[EN] 6 週・需要快速產出, AI 拆解結果已附",
    "inbox_maru_zh": "[EN] 4 週・小型專案, 試做機會"
  }
