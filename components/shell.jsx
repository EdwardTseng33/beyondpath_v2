...
const BP_USERS = {
  client: { name: "Edward", email: "edward@lumine.tw", img: "assets/edward.jpg", color: "#4285F4" },
  worker: { name: "Edward", email: "edward@beyondpath.io", img: "assets/edward.jpg", color: "#0F9D58" },
};
  ...
  return (
    <div className="bp-shell">
      ...
      <div className="bp-shell-body">
        ...
        {role === "worker" && <window.BP_WorkerDashboard inShell={true} />}
      </div>
    </div>
  );
}
